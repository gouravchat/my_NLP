...
if __name__ == '__main__':
    ...
    indexed_sentences,word2idx=get_sentences_with_word2idx_limit_vocab(n_vocab=2000)
    ...
    for epoch in range(epochs):
        ...
        for sentence in indexed_sentences:
            ...
            if j%10 == 0 :
                print('Epoch: ',epoch,'count: ',j,'loss :',loss)
            j = j + 1

    print('Elapsed time during training :',datetime.datetime.now()-t0)
    plt.plot(losses)
